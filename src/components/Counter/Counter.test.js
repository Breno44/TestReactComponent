...
describe("Counter component", () => {
  ...
  test("deve adicionar a classe counter__title--increment no titulo, quando o valor for maior do que zero", () => {
    render(<Counter />);
  ...
  test("deve adicionar a classe counter__title--decrement no titulo, quando o valor for menor do que zero", () => {
    render(<Counter />);
